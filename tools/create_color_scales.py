...
def hue_to_scale(height, width):
    ...
    for y in range(height):
        for x in range(width):
            ...
            hue_scaled_down = Utils.scale_between_range(hue, CV_HSV_MIN_MAX[0], KEY_STEP_MIN_MAX)
            hue_scaled_up = Utils.scale_between_range(hue_scaled_down, KEY_STEP_MIN_MAX, CV_HSV_MIN_MAX[0])
